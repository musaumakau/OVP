...
$sql="INSERT INTO voter(name,idno,gender,subcounty,county,ward,location,img) VALUES(:name,:idno,:gender,:subcounty,:county,:location
,:ward,:vimage1)";
...
if($lastInsertId)
{
$msg="Voter Successfully Registered";
}
else 
{
...
<head>
	...
	<title>Online Voting  Portal | Admin Register A Voter</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Register A Voter</h2>
...
<label class="col-sm-2 control-label">Voter's Full Name<span style="color:red">*</span></label>
<div class="col-sm-4">
