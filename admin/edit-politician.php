...
$seatvying=$_POST['seatvying'];
$party=$_POST['party'];
$vimage1=$_FILES["img"]["name"];

move_uploaded_file($_FILES["img"]["tmp_name"],"img/politicianimage/".$_FILES["img"]["name"]);
$sql="INSERT INTO politician(name,idno,gender,subcounty,county,ward,location,img,seatvying,party) VALUES(:name,:idno,:gender,:subcounty,:county,:location
,:ward,:vimage1,:seatvying,:party)";
$query = $dbh->prepare($sql);
$query->bindParam(':name',$name,PDO::PARAM_STR);
$query->bindParam(':idno',$idno,PDO::PARAM_STR);
$query->bindParam(':gender',$gender,PDO::PARAM_STR);
$query->bindParam(':subcounty',$subcounty,PDO::PARAM_STR);
$query->bindParam(':county',$county,PDO::PARAM_STR);
$query->bindParam(':ward',$ward,PDO::PARAM_STR);
$query->bindParam(':location',$location,PDO::PARAM_STR);
$query->bindParam(':vimage1',$vimage1,PDO::PARAM_STR);
$query->bindParam(':seatvying',$seatvying,PDO::PARAM_STR);
$query->bindParam(':party',$party,PDO::PARAM_STR);
...
if($lastInsertId)
{
$msg="Politician Details Succesfully Updated";
}
else 
{
...
<head>
	...
	<title>Online Voting  Portal | Admin Edit Politician</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Register A Politician</h2>
...
<div class="form-group">
<label class="col-sm-2 control-label">Seat Vying<span style="color:red">*</span></label>
<div class="col-sm-4">
<input type="text" name="seatvying" class="form-control" required>
</div>
</div>
<div class="form-group">
<label class="col-sm-2 control-label">Political Party<span style="color:red">*</span></label>
<div class="col-sm-4">
...
<div class="form-group">
<div class="col-sm-12">
<h4><b>Upload Politician Image</b></h4>
</div>
</div>
