...
<head>
	...
	<title>Online Voting Panel | Admin Dashboard</title>
...
<?php 
$sql ="SELECT id from voter ";
$query = $dbh -> prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
$voters=$query->rowCount();
?>
													<div class="stat-panel-number h1 "><?php echo htmlentities($voters);?></div>
													<div class="stat-panel-title text-uppercase">Registered Voters</div>
												</div>
											</div>
											<a href="manage-voters.php" class="block-anchor panel-footer">Full Detail <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-success text-light">
												<div class="stat-panel text-center">
												<?php 
$sql1 ="SELECT id from politicalparty";
$query1 = $dbh -> prepare($sql1);;
$query1->execute();
$results1=$query1->fetchAll(PDO::FETCH_OBJ);
$totalparty=$query1->rowCount();
?>
													<div class="stat-panel-number h1 "><?php echo htmlentities($totalparty);?></div>
													<div class="stat-panel-title text-uppercase"> Political Parties</div>
												</div>
											</div>
											<a href="manage-party.php" class="block-anchor panel-footer text-center">Full Detail &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-info text-light">
												<div class="stat-panel text-center">
<?php 
$sql2 ="SELECT id from office ";
$query2= $dbh -> prepare($sql2);
$query2->execute();
$results2=$query2->fetchAll(PDO::FETCH_OBJ);
$offices=$query2->rowCount();
?>

													<div class="stat-panel-number h1 "><?php echo htmlentities($offices);?></div>
													<div class="stat-panel-title text-uppercase">Political Offices</div>
												</div>
											</div>
